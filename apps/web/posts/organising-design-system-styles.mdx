...
lede: Well-crafted UI is your last defense against the coming slopwave of careless AI apps. Here's how customizing Tailwind can save you time and design bugs so you can focus on the irrational amount of care it takes to build good UI.
assets:
  - src: /images/post-tailwind-config-1920-1080b.jpg
